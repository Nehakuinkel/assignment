								...
								<figure>
									<div className="snipcart-item block">
										<div className="snipcart-thumb">
											<Link to="single.html"><img src="../Assets/images/5.png" alt=" " className="img-responsive" /></Link>
						...
						<div className="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div className="agile_top_brand_left_grid1">
								<figure>
									<div className="snipcart-item block">
										<div className="snipcart-thumb">
											<Link to="single.html"><img src="../Assets/images/6.png" alt=" " className="img-responsive" /></Link>
						...
						<div className="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div className="agile_top_brand_left_grid1">
								<figure>
									<div className="snipcart-item block">
										<div className="snipcart-thumb">
											<Link to="single.html"><img src="../Assets/images/7.png" alt=" " className="img-responsive" /></Link>
