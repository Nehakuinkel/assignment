...
{/* <!--typography-page --> */}
		<div className="typo">
			...
			<div className="grid_3 grid_4">
				...
				<div className="bs-example">
					<table className="table">
						<tbody>
							<tr>
								<td><h1 id="h1.-bootstrap-heading">h1. Bootstrap heading<Link className="anchorjs-link" href="#h1.-bootstrap-heading"><span className="anchorjs-icon"></span></Link></h1></td>
								<td className="type-info">Semibold 36px</td>
							</tr>
							<tr>
								<td><h2 id="h2.-bootstrap-heading">h2. Bootstrap heading<Link className="anchorjs-link" href="#h2.-bootstrap-heading"><span className="anchorjs-icon"></span></Link></h2></td>
								<td className="type-info">Semibold 30px</td>
							</tr>
							<tr>
								<td><h3 id="h3.-bootstrap-heading">h3. Bootstrap heading<Link className="anchorjs-link" href="#h3.-bootstrap-heading"><span className="anchorjs-icon"></span></Link></h3></td>
								<td className="type-info">Semibold 24px</td>
							</tr>
							<tr>
								<td><h4 id="h4.-bootstrap-heading">h4. Bootstrap heading<Link className="anchorjs-link" href="#h4.-bootstrap-heading"><span className="anchorjs-icon"></span></Link></h4></td>
								<td className="type-info">Semibold 18px</td>
							</tr>
							<tr>
								<td><h5 id="h5.-bootstrap-heading">h5. Bootstrap heading<Link className="anchorjs-link" href="#h5.-bootstrap-heading"><span className="anchorjs-icon"></span></Link></h5></td>
			...
			<div className="grid_3 grid_5">
				<h3>Badges</h3>
				<div className="col-md-6">
					<p>Add modifier classNamees to change the appearance of a badge.</p>
      ...
      {/* <!-- /.row --> */}
			...
			<p>Add any of the following classNamees to the <code>.table</code> base className.</p>
