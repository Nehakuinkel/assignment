		...
		<div className="services">
			...
			<div className="w3ls_service_grids1">
				...
				<div className="col-md-6 w3ls_service_grids1_right">
					<ul>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>et voluptates repudiandae sint et molestiae</li>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>rerum necessitatibus saepe eveniet ut</li>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>placeat facere possimus, omnis voluptas</li>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>Et harum quidem rerum facilis est et expedita</li>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>similique sunt in culpa qui officia deserunt</li>
						<li><i className="fa fa-long-arrow-right" aria-hidden="true"></i>odio dignissimos ducimus qui blanditiis</li>
					</ul>
...
<!-- services-bottom --> */}
	<div className="services-bottom">
		<div className="container">
			...
			<div className="col-md-3 about_counter_left">
				<i className="glyphicon glyphicon-piggy-bank" aria-hidden="true"></i>
