		...
		<div className="privacy">
			<div className="privacy1">
				...
				<div className="banner-bottom-grid1 privacy1-grid">
					<ul>
						<li><i className="glyphicon glyphicon-user" aria-hidden="true"></i></li>
					...
					<ul>
						<li><i className="glyphicon glyphicon-search" aria-hidden="true"></i></li>
						<li>Search <span>Excepteur sint occaecat cupidatat non proident, sunt in
							culpa qui officia deserunt mollit anim id est laborum.</span></li>
					</ul>
					<ul>
						<li><i className="glyphicon glyphicon-paste" aria-hidden="true"></i></li>
						<li>News Feed <span>Excepteur sint occaecat cupidatat non proident, sunt in
							culpa qui officia deserunt mollit anim id est laborum.</span></li>
					</ul>
					<ul>
						<li><i className="glyphicon glyphicon-qrcode" aria-hidden="true"></i></li>
